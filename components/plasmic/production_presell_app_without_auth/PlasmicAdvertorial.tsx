...
import sty from "./PlasmicAdvertorial.module.css"; // plasmic-import: 9myunOrxR2-e/css
...
export type PlasmicAdvertorial__ArgsType = {
  ...
  editable?: string;
  onEdit?: () => void;
  articleParagraph22?: string;
  onArticleParagraph2Change?: (val: string) => void;
};
...
function PlasmicAdvertorial__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      {
        path: "articleParagraph22",
        type: "writable",
        variableType: "text",

        valueProp: "articleParagraph22",
        onChangeProp: "onArticleParagraph2Change"
      },
      {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    cms: usePlasmicDataOp(() => {
      return {
        ...
        opId: "76fa5645-96da-4155-99ae-8ae7c2f4d1d6",
        userArgs: {
          filters: [$queries.pages.data[0].cms]
        },
        cacheKey: `plasmic.$.76fa5645-96da-4155-99ae-8ae7c2f4d1d6.$.`,
    ...
    >
      {(() => {
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__cGsjv)}>
              <Editable
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "912c22c0-7bb4-461e-a150-39dff49e0294",
                                  userArgs: {
                                    keys: [$queries.cms.data[0].id],
            ...
            <div className={classNames(projectcss.all, sty.column__w6Xhz)}>
              <Editable
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "f81c06c5-5825-4a3a-bb2c-8b65d5d2aaea",
                                  userArgs: {
                                    keys: [$queries.cms.data[0].id],
      ...
      {(() => {
        ...
        >
                    ...
                    $steps["postgresUpdateById"] = true
                      ? (() => {
                          const actionArgs = {
                            dataOp: {
                              sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                              opId: "c42631fa-9990-4edb-9141-6121a8ece3c2",
                              userArgs: {
                                keys: [$queries.cms.data[0].id],
                    ...
                    $steps["postgresUpdateById"] = true
                      ? (() => {
                          const actionArgs = {
                            dataOp: {
                              sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                              opId: "74b368f7-25fe-4ab7-9982-1cf3b1aebf0a",
                              userArgs: {
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__hO5Cq)}>
              <PlasmicImg__
      ...
      {(() => {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__bi4Ku)}>
            <div
            ...
            >
                            ...
                            $steps["postgresUpdateById"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                      opId: "b9df5129-f16c-40a5-baf3-3c860ed2856f",
                                      userArgs: {
                                        keys: [$queries.cms.data[0].id],
                        ...
                        $steps["updateEditArticleHeadlineValue"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "07053b8c-4865-4317-9b4f-d634946dab24",
                                  userArgs: {
                                    keys: [$queries.cms.data[0].id],
                        ...
                        $steps["updateEditArticleHeadlineValue2"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "01cce7c6-1e6f-4f93-ae96-c5a53f228bfb",
                                  userArgs: {
                                    keys: [$queries.cms.data[0].id],
                                    variables: [
                                      $state.editText6.value,
                                      $state.editText6.value
                                    ]
                                  },
                                  cacheKey: null,
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "4fe1d124-257f-4f1f-83ee-ff86bd46742d",
                                  userArgs: {
                                    keys: [$queries.pages.data[0].cms],
                                    variables: [
                                      $state.editText7.value,
                                      $state.editText7.value
                                    ]
                                  },
                                  cacheKey: null,
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "b4038b98-9f87-4c6a-82c5-08ad73e01501",
                                  userArgs: {
                                    keys: [$queries.pages.data[0].cms],
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___6M5Vw)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__otIth)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__ir5Zx)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___1OdM5)}
                  displayHeight={
                    hasVariant(globalVariants, "screen", "mobileOnly")
                      ? "auto"
                      : "auto"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__zJYii)}>
                <div className={classNames(projectcss.all, sty.freeBox__uua3W)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__wVsp)}
                    displayHeight={"auto"}
                ...
                <div
                  className={classNames(projectcss.all, sty.freeBox___9Ocua)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "85c8ff49-b36d-4ffd-ac62-1252754ffcf4",
                                  userArgs: {
                                    keys: [$queries.pages.data[0].cms],
                                    variables: [$state.editText9.value]
                                  },
                                  cacheKey: null,
                                  invalidatedKeys: ["plasmic_refresh_all"],
                                  roleId: null
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "c9b59c2e-a414-47bf-af49-5c3f97e1fef8",
                                  userArgs: {
                                    keys: [$queries.pages.data[0].cms],
                        ...
                        $steps["postgresUpdateById"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                  opId: "753d0b83-63d8-4d99-9405-db76ea4191a7",
                                  userArgs: {
                                    keys: [$queries.pages.data[0].cms],
              ...
              <div className={classNames(projectcss.all, sty.freeBox__aXcK2)}>
                {(() => {
                  try {
                    return $queries?.cms?.data[0]?.text_3 != null;
                  } catch (e) {
                ...
                {(
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__kElsp)}
                  />
                ) : null}
                {(
                  hasVariant(globalVariants, "screen", "mobileOnly")
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__bxcGr)}
                  >
                    <Editable
                              ...
                              $steps["postgresUpdateById"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                        opId: "c03f2315-738c-43ab-b11e-7f162d54b511",
                                        userArgs: {
                                          keys: [$queries.pages.data[0].cms],
                              ...
                              $steps["postgresUpdateById"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                        opId: "8899770c-8b69-4437-b0c8-d737e1486098",
                                        userArgs: {
                                          keys: [$queries.pages.data[0].cms],
                              ...
                              $steps["postgresUpdateById"] = true
                                ? (() => {
                                    const actionArgs = {
                                      dataOp: {
                                        sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                        opId: "d04d31b4-1c36-4bc3-b5b0-75eafa11c4fa",
                                        userArgs: {
                            ...
                            $steps["postgresUpdateById"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                      opId: "af9a3c7c-51dc-4ae2-8a1a-d574c1e521bd",
                                      userArgs: {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__fbnbl)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__xwXaT,
              ...
              >
                <Editable
                  className={classNames("__wab_instance", sty.editable__bwMj6)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "5a4c0951-9372-42a4-9056-b20177672f7e",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable___31RzQ)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "c3943421-817a-4b4b-bdaf-3fdd77464b01",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable__jeoub)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "deed669d-783e-48aa-b2bc-b7f523b8ef01",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "cb861d3d-3382-42b7-8585-1fba65cba730",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8WNzf)}>
                <Editable
                  className={classNames("__wab_instance", sty.editable___4U9Aq)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById2"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "084688a1-cb86-466f-9879-c5d1cbb70134",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable__s39P3)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "2d5d3a70-9a2b-44a3-b636-c6e0e27f6acb",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable___8F3E9)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "efc96346-1aac-4471-98a1-a0cf378bdea8",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "0d444571-fcab-4973-8517-d9bd8f956c3f",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
              ...
              <div className={classNames(projectcss.all, sty.freeBox__iR1Ip)}>
                <Editable
                  className={classNames("__wab_instance", sty.editable__eNvJh)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "2f951fed-bb7a-4cf5-9d7b-d417f9a705d1",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable__iiC4A)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "b5b6ea31-6249-42d6-a3e7-85e5914ea58d",
                                    userArgs: {
                                      keys: [$queries.cms.data[0].id],
                ...
                <Editable
                  className={classNames("__wab_instance", sty.editable__hkFlT)}
                  edit2={
                    <TextInput
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "1bc0a6a1-7bea-442a-8a98-76e682f93786",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
                          ...
                          $steps["postgresUpdateById"] = true
                            ? (() => {
                                const actionArgs = {
                                  dataOp: {
                                    sourceId: "g2kPPaDE2d7MrKWxSfsPF6",
                                    opId: "a320a3e5-5730-4b57-8202-5a3ded300af9",
                                    userArgs: {
                                      keys: [$queries.pages.data[0].cms],
              ...
              <div className={classNames(projectcss.all, sty.freeBox__lyuOh)}>
                <PlasmicImg__
