...
import sty from "./PlasmicLearnMoreButton.module.css"; // plasmic-import: BZFgfdM3hCN6/css
...
export type PlasmicLearnMoreButton__VariantMembers = {
...
export type PlasmicLearnMoreButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicLearnMoreButton__VariantsArgs;
export const PlasmicLearnMoreButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicLearnMoreButton__ArgsType = {
...
type ArgPropType = keyof PlasmicLearnMoreButton__ArgsType;
export const PlasmicLearnMoreButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicLearnMoreButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultLearnMoreButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicLearnMoreButton__RenderFunc(props: {
  variants: PlasmicLearnMoreButton__VariantsArgs;
  args: PlasmicLearnMoreButton__ArgsType;
  overrides: PlasmicLearnMoreButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mDdht)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__oqgfI)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicLearnMoreButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicLearnMoreButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicLearnMoreButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicLearnMoreButton__ArgsType,
      ReservedPropsType
    > &
