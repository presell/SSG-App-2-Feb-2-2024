...
import sty from "./PlasmicBrandButton.module.css"; // plasmic-import: ZBgO5b3CrImX/css
...
export type PlasmicBrandButton__VariantMembers = {
...
export type PlasmicBrandButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicBrandButton__VariantsArgs;
export const PlasmicBrandButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicBrandButton__ArgsType = {
...
type ArgPropType = keyof PlasmicBrandButton__ArgsType;
export const PlasmicBrandButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicBrandButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultBrandButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicBrandButton__RenderFunc(props: {
  variants: PlasmicBrandButton__VariantsArgs;
  args: PlasmicBrandButton__ArgsType;
  overrides: PlasmicBrandButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__dvOh7)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ipbKa)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicBrandButton>(
    PlasmicBrandButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicBrandButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicBrandButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicBrandButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBrandButton__ArgProps,
          internalVariantPropNames: PlasmicBrandButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBrandButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBrandButton";
  } else {
    func.displayName = `PlasmicBrandButton.${nodeName}`;
  }
  return func;
}

export const PlasmicBrandButton = Object.assign(
  // Top-level PlasmicBrandButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicBrandButton
    internalVariantProps: PlasmicBrandButton__VariantProps,
    internalArgProps: PlasmicBrandButton__ArgProps,

    useBehavior
  }
);

export default PlasmicBrandButton;
/* prettier-ignore-end */
