...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: aneBXCyWmf1-/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: PuK2tEQTRiB_/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__nlPxo)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___7Df9U)}
              />
            </React.Fragment>
          ),
          value: args.children
