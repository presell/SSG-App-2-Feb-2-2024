...
import sty from "./PlasmicHoverButton.module.css"; // plasmic-import: 7Jdvuh5TtzqX/css
...
export type PlasmicHoverButton__VariantMembers = {
...
export type PlasmicHoverButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicHoverButton__VariantsArgs;
export const PlasmicHoverButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicHoverButton__ArgsType = {
...
type ArgPropType = keyof PlasmicHoverButton__ArgsType;
export const PlasmicHoverButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicHoverButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultHoverButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicHoverButton__RenderFunc(props: {
  variants: PlasmicHoverButton__VariantsArgs;
  args: PlasmicHoverButton__ArgsType;
  overrides: PlasmicHoverButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___7BcYt)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ymHtZ)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicHoverButton>(
    PlasmicHoverButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHoverButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicHoverButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicHoverButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHoverButton__ArgProps,
          internalVariantPropNames: PlasmicHoverButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHoverButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHoverButton";
  } else {
    func.displayName = `PlasmicHoverButton.${nodeName}`;
  }
  return func;
}

export const PlasmicHoverButton = Object.assign(
  // Top-level PlasmicHoverButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHoverButton
    internalVariantProps: PlasmicHoverButton__VariantProps,
    internalArgProps: PlasmicHoverButton__ArgProps,

    useBehavior
  }
);

export default PlasmicHoverButton;
/* prettier-ignore-end */
